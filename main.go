	...
	for update := range updates {
		...
		case cmdStart:
			originalText := "👋 *Привет! Я — твой универсальный помощник в мире искусственного интеллекта.*\n\n" +
				...
				"1. Для генерации текста просто напиши мне свой запрос, например:\n" +
				"   - \"Напиши рассказ про космос\"\n" +
				"   - \"Придумай идею для стартапа\"\n" +
				"2. Для создания изображения используй команду `/dalle` и опиши, что ты хочешь увидеть, например:\n" +
				"   - `/dalle Космический корабль в стиле киберпанк`\n" +
